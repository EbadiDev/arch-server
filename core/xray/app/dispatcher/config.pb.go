...
var file_config_proto_goTypes = []interface{}{
	(*SessionConfig)(nil), // 0: Arch-Server.core.app.dispatcher.SessionConfig
	(*Config)(nil),        // 1: Arch-Server.core.app.dispatcher.Config
}
var file_config_proto_depIdxs = []int32{
	0, // 0: Arch-Server.core.app.dispatcher.Config.settings:type_name -> Arch-Server.core.app.dispatcher.SessionConfig
