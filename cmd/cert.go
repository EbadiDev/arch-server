...
func init() {
	...
	certCommand.Flags().StringVarP(&certCommonName, "name", "", "Arch-Server Inc", "The common name of this certificate")
	certCommand.Flags().StringVarP(&certOrganization, "org", "", "Arch-Server Inc", "Organization of the certificate")
	...
	certCommand.Flags().StringVarP(&certFilePath, "output", "", "/etc/Arch-Server/cert", "Save certificate in file.")
}
